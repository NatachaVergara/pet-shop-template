                ...
                <div className="container py-5">
                    <div className="row justify-content-start">
                        <div className="col-lg-8 text-center text-lg-start">
                            ...
                            <h2 className="text-uppercase text-white mb-lg-4">Hace feliz a tus mascotas</h2>
                            ...
                            <div className="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                                <Link to='sobreNosotros' spy={true} smooth={true}  duration={250}  className="btn btn-outline-light border-2 py-md-3 px-md-5 me-5">Leer más</Link>
